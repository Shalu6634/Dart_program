...
class Bank {
  late String balance, eyeColor, name, gender;
  late String company, email, address, phone;
  late int age;
  late bool isActive;
  Bank(
...
void main() {
  for (int i = 0; i < bankData.length; i++) {
    BankModel b1 = BankModel.formBank(BankList: bankData[i]);
    l1.add(b1);
  }
  for (int i = 0; i < l1.length; i++) {
    stdout.write(
      'isActive : ${l1[i].isActive}' +
          '\n' 'age " ${l1[i].age}' +
